...
TODAY_DAY = date_today.strftime('%d')
TODAY_MONTH = date_today.strftime('%m')
TODAY_YEAR = date_today.strftime('%Y')
...
def sl_scan():
    for i in range(4):
        read_path = dumper_file_dir + "DUMP_" + str(date_now) + "_" + "07300" + str(i + 1) + ".csv_Clean"
        ...
        dest_path = aggregate_file_dir + "sl/scan/sl_" + str(date_now) + "_" + "07300" + str(i + 1) + ".csv"
