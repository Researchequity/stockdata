...
def main(interval,script_code,input_file_path,order_id):
    ...
    prefix="E:\DUMPER\Stream_by_token\metadata"
...
if __name__ == '__main__':
    ...
    stream_path = "Y:\\DUMPER\\fno_" + str(date) + "_07300" + stream + ".csv_clean"
    drop_path = "C:\\Python_Ankit\\Project_Stream\\Data\\TBT_" + str(date) + "_" + token + ".csv"
