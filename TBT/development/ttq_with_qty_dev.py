...
dat_today = date_today.strftime('%Y%m%d')
stream = str(input('Enter stream:'))
file_name = str('tbt-ncash-str'+ str(stream) +'/DUMP_'+ str(dat_today) +'_07300' + str(stream) + '.DAT')
gToken = str(input('Enter gtoken:'))
gQty = str(input('Enter gqty:'))
gInputExOrderId = str(input('Enter order id:'))
...
#    print gInputExOrderId, exOrderId
    if int(exOrderId) == int(gInputExOrderId):
