...
def CalculationOfNeedToTradeForAOrder():
    ...
    orderCounter=1
    print "Price      OrderRemain      QtyRemain"
    if gSide == 'B':
...
#                     if priceKey == gVerificationOrdPrice and isProvidedOrdBestOrderCount == 0:
#                         print "BUY:At-Price:", gVerificationOrdPrice, "Remaing Qty :", 0, "Need to trade-qty:", gOrderDictionary[gInputExOrderId].qty
#                         sys.exit()
                    isProvidedOrdBestOrderCount = isProvidedOrdBestOrderCount + 1
                    print priceKey, "      ", orderCounter, "             ", gBuyPriceDictionary[priceKey].totalQty
        ...
        print "\n\nTotal Order Remain:", orderCounter - 1
...
#                     if priceKey == gVerificationOrdPrice and isProvidedOrdBestOrderCount == 0:
#                         print "SELL:At-Price:", gVerificationOrdPrice, "Remaing Qty :", 0, "Need to trade-qty:",  gOrderDictionary[gInputExOrderId].qty 
#                         sys.exit()
                    print priceKey, "      ", orderCounter, "             ", gSellPriceDictionary[priceKey].totalQty, totalQty
