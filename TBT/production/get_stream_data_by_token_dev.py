...
def main(interval, script_code, input_file_path, order_id):
    ...
    # df_live_stream_pending_gtr['token'] = df_live_stream_pending_gtr['token'].astype(str)
    ...
    # df_live_stream_pending_smlr['token'] = df_live_stream_pending_smlr['token'].astype(str)
    ...
    if timesleep < "09:45":
        ...
        for token, stream in zip(tokens, streams):
            ...
            try:
                ...
                if os.path.exists(r'//home/workspace/aggregate/stream_by_token_' + str(date) + '_' + token + '.csv'):
                    os.remove(r'//home/workspace/aggregate/stream_by_token_' + str(date) + '_' + token + '.csv')
                if os.path.exists(r'//home/workspace/aggregate/stream_by_token_' + str(date) + '_' + token + '.csv_str'):
                    os.remove(r'//home/workspace/aggregate/stream_by_token_' + str(date) + '_' + token + '.csv_str')
            except:
                continue
